...
var painter = require("table-on-canvas");
var table = function () { return __awaiter(void 0, void 0, void 0, function () {
    var canvas, base64;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            //1. create a table
            return [4 /*yield*/, painter.createTable()];
            case 1:
                //1. create a table
                _a.sent();
                ...
                return [4 /*yield*/, painter.drawTable()];
            case 2:
                canvas = _a.sent();
                return [4 /*yield*/, canvas.toDataURL().split("base64,").pop()];
            case 3:
                base64 = _a.sent();
